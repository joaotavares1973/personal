...
<tiles:insertDefinition name="template">
	<tiles:putAttribute name="corpo">
		...
		<script type="text/javascript" charset="utf-8">
			...
			function incluir() {
				$('#ListaDesignacoesView').attr('action', "${pageContext.request.contextPath}/incluirDesignacoes.bpss");
				$("#ListaDesignacoesView").submit();
			}
		...
		<springform:form name="listaDesignacoes" method="post"
			...
			modelAttribute="ListaDesignacoesView">
			...
			<fieldset>
				...
				<a class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="javascript:incluir();">
